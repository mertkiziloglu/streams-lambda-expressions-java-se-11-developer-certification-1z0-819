...
public class TestData {
    ...
    public static final Product SCOURER = new Product(Category.CLEANING, "Scourer", new BigDecimal("2.29"));
    public static final Product DISH_BRUSH = new Product(Category.CLEANING, "Dish brush", new BigDecimal("3.49"));
    public static final Product NOTEBOOK = new Product(Category.OFFICE, "Notebook", new BigDecimal("4.99"));
    public static final Product BALLPOINT_PENS = new Product(Category.OFFICE, "Ballpoint pens", new BigDecimal("6.79"));
